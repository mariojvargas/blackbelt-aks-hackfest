...
function kubeJobRunner (config, k) {
    ...
    k.image = "lachlanevenson/k8s-kubectl:v1.8.11"
    k.tasks = [
        `kubectl set image deployment/heroes-web-deploy heroes-web-cntnr=marioacr.azurecr.io/azureworkshop/rating-web:${config.get("imageTag")}`
    ]
}
